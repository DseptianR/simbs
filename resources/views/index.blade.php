...
@section('title', 'Beranda — SIMBS Bank Sampah')
...
<section class="hero" id="hero">
    ...
    <div class="hero-bg">
        <div class="hero-overlay"></div>
         <img src="{{ asset('images/bg sampah.jpeg') }}" alt="Bank Sampah"> 
    ...
    <div class="hero-content" data-animate="fade-up">
        ...
        <div class="hero-actions">
            <a href="{{ route('nasabah.register') }}" class="btn-primary">
                <span>Daftar</span>
                <i class="fas fa-arrow-right"></i>
            </a>
            <a href="{{ url('/nasabah/login') }}" class="btn-ghost">
...
<section class="stats-section">
    <div class="stats-container">
        ...
        <div class="stat-card" data-animate="fade-up" data-delay="300">
            ...
            <div class="stat-number" data-count="{{ $stats['titik_pengumpulan'] }}">0</div>
            <div class="stat-unit"></div>
...
<section class="waste-section">
    ...
    <div class="waste-grid" style="grid-template-columns: repeat(3, 1fr);">
        @forelse($kategoriList as $i => $kat)
        <div class="waste-card" data-animate="fade-up" data-delay="{{ ($i % 3) * 100 }}">
            <div class="waste-icon" style="--c: {{ $colors[$i % count($colors)] }}">
                <span style="font-size:28px; line-height:1;">{{ $kat->ikon }}</span>
            </div>
            <h3>{{ $kat->nama }}</h3>
            <p>{{ $kat->deskripsi }}</p>
            <div class="waste-price">Rp {{ number_format($kat->harga_per_satuan, 0, ',', '.') }} – {{ number_format($kat->harga_jual, 0, ',', '.') }} / kg</div>
        </div>
        @empty
